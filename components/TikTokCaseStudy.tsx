  ...
  <div className="tk-viewport" ref={viewport}>
   <div className="tk-track" ref={track}>
    ...
    <article id="tk-data" className="tk-panel tk-data">
     <header><span className="tk-label">03 / DATA ANALYSIS &amp; ITERATION</span><h3>Using data analysis<br/>to shape the next iteration.</h3><p>I built and used a performance dashboard to connect engagement, audience, growth and supply signals—turning daily and weekly behaviour into clear product and operational decisions.</p></header>
     <div className="tk-measurement"><div className="tk-measurement-heading"><span>PERFORMANCE DASHBOARD / DATA ANALYSIS</span><span>DAILY / WEEKLY</span></div><div className="tk-data-lenses"><div><span>01 / ENGAGEMENT</span><h4>How do people<br/>respond?</h4><p>Likes · Comments · Shares<br/>Click-through rate</p></div><div><span>02 / AUDIENCE</span><h4>Who are we<br/>reaching?</h4><p>Age · Gender · Location<br/>Language · Device</p></div><div><span>03 / GROWTH</span><h4>Is traction<br/>building?</h4><p>GMV · Auction penetration<br/>Average order value</p></div><div><span>04 / SUPPLY</span><h4>What sustains<br/>the marketplace?</h4><p>Seller count · Seller tiers<br/>LIVE hours · Active accounts<br/>Seller contribution · Campaign uplift</p></div></div><div className="tk-process">DASHBOARD <span>→</span> ANALYSIS <span>→</span> DECISION <span>→</span> ITERATION</div></div>
    </article>

...
export const assets:{portrait:string;aboutPhotos:(string|null)[];f1:string|null;monitor:string|null;communication:string[][];email:string|null;linkedin:string|null;resume:string|null;paper:string|null}={portrait:assetPath('/kexin-ye-portrait.jpg'),aboutPhotos:[null,null],f1:null,monitor:null,communication:[[],[]],email:null,linkedin:null,resume:null,paper:assetPath('/research/green-finance-kexin-ye.pdf')};
export const academicPaper = {
 ...
 url:assetPath('/research/green-finance-kexin-ye.pdf'),
 cover:assetPath('/research/green-finance-cover.png'),
...
export const communicationGalleries = [
 [
  {title:'Information Management',subtitle:'Organizing the story',images:[{src:assetPath('/communication/tdt-information.png'),caption:'Shared information and content asset library'}]},
  {title:'Content to Attract Audiences',subtitle:'Making people care',images:[{src:assetPath('/communication/tdt-water.png'),caption:'Women & Water — audience-facing campaign content'}]},
  {title:'Visual Storytelling',subtitle:'Graphic design · social communication',images:[{src:assetPath('/communication/tdt-values.png'),caption:'Values campaign — graphic design and visual communication'}]},
  {title:'Campaign Graphics',subtitle:'Designing for communication',images:[{src:assetPath('/communication/tdt-campaigns.png'),caption:'Newsletter, project themes and fundraising campaign graphics'}]},
  {title:'Fundraising Results',subtitle:'Turning attention into impact',images:[{src:assetPath('/communication/tdt-fundraising.png'),caption:'The campaign raised £21,725 — fundraising supported through communication'}]}
 ],
 [
  {title:'Creative Transitions',subtitle:'Graduation · Independent editing',images:[{src:assetPath('/communication/xhs-graduation.png'),caption:'Creative graduation transitions · independently edited by Kexin Ye'}]},
  {title:'Daily Vlogs',subtitle:'Campus life · Independent editing',images:[{src:assetPath('/communication/xhs-lse.png'),caption:'Daily vlogs sharing university life · independently edited by Kexin Ye'}]},
  {title:'Creative Transitions',subtitle:'Life milestones · Independent editing',images:[{src:assetPath('/communication/xhs-ruc.png'),caption:'Life milestones told through creative transitions · independently edited by Kexin Ye'}]},
  {title:'Creative Transitions',subtitle:'Unboxing · Independent editing',images:[{src:assetPath('/communication/xhs-fudan.png'),caption:'An admission-letter unboxing with creative transitions · independently edited by Kexin Ye'}]},
  {title:'Daily Vlogs',subtitle:'Life in London · Independent editing',images:[{src:assetPath('/communication/xhs-museum-vlog.png'),caption:'A museum ball in London · daily vlog independently edited by Kexin Ye'}]}
 ]
];
